using Ship.Ses.Extractor.Application.Customer.ChangeEmail;
using Ship.Ses.Extractor.Application.Exceptions;
using Ship.Ses.Extractor.Domain.Customers;
using MassTransit;
using Microsoft.Extensions.Logging;
using Moq;

namespace Ship.Ses.Extractor.Application.UnitTests.Customer.ChangeEmailTests
{
    public class ChangeEmailCommandHandlerTests
    {
        ...
        public async Task Should_Throw_CustomerNotFoundApplicationException_When_Customer_Does_Not_Exist()
        {
            ...
            _customerRepositoryMock.Setup(repo => repo.GetAsync(customerId, default)).ReturnsAsync((Ship.Ses.Extractor.Domain.Customers.Customer?)null);
