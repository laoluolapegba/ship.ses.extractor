using Ship.Ses.Extractor.Application.Customer.GetCustomer;
...
namespace Ship.Ses.Extractor.Infrastructure.UnitTests.Queries.GetCustomer
{
    public class GetCustomerQueryHandlerTests
    {
        ...
        public async Task Should_Get_Customer_From_Cache()
        {
            ...
            _cacheServiceMock
                .Setup(repo => repo.GetAsync<CustomerDto>(Ship.Ses.Extractor.Application.Shared.CacheKeyBuilder.GetCustomerKey(_expectedCustomer.CustomerId), It.IsAny<CancellationToken>()))
